    ...
    <div className="w-[1440px] flex flex-col items-center justify-center px-[128px]">
      ...
      <div className="flex flex-row items-center mt-[64px] gap-6 w-full">
        <div className="flex flex-col w-[580px] ">
          <div className=" h-[320px] bg-[#584440] p-4 flex flex-row gap-4 ">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="w-[168px] font-normal text-lg  leading-[25px] h-[137px] bg-[#584440] flex flex-col items-center justify-center">
                +33 more
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col w-[580px]  overflow-hidden">
          <div className="h-[320px] bg-[#E5B5A1] p-4 flex flex-row  justify-center gap-4">
            <div className="flex flex-col gap-4 ">
              <div className="w-[174px] h-[179px] overflow-hidden">
                <Image
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="w-[173px] font-normal text-lg  leading-[25px] h-[93px] bg-[#E5B5A1] flex flex-col items-center justify-center">
                +33 more
              </div>
            </div>
          </div>
