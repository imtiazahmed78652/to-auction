...
function AuctionEnding() {
  ...
  return (
    <div className='px-[128px] mt-[175px] '>
        <h1 className='text-[36px] font-normal leading-[46px] text-[#686868]'> Auction Ending</h1>
        ...
        >
      {
        ...
        <h1 className='font-normal text-4xl leading-[46px] text-[#686868]'>How It Works?</h1> 
        ...
        <div className='flex flex-row items-center justify-between bg-[#283926] w-[1664px] h-[775px] px-[200px] py-[180px] rounded-[64px] mt-[64px]'>
         {
          ...
          return <div key={idx} className='flex flex-col items-center'>
            {
              idx === 0 && <Image src = {element.img} width={282} height={261} alt=''/>
            }
          {
            idx === 1 && <Image src = {element.img} width={252} height={256} alt=''/>
          }
          {
            idx === 2 && <Image src = {element.img} width={221} height={256} alt=''/>
          }
          <h1 className='font-bold text-2xl leading-[38px] text-[#5AE842] mt-[66px]'>{element.name}</h1>
          <p className='font-medium text-base leading-[21.86px] max-w-[286px] text-center mt-[27px] text-white'>{element.des}</p>
          </div>
          })
         } 
