...
function AboutUs() {
  ...
  return (
    ...
    <div className='px-[128px]  py-[141px] flex flex-row items-center justify-center gap-[141px]'>
        <div className='flex flex-col gap-[72px] h-[606px]'>
                ...
                <div className='flex flex-col gap-[36px] '>
           {
            data.map((element,idx)=> {
                ...
                <div className='w-[704px] font-medium  text-[16px] text-[#7D7D7D] leading-[21.86px]'>{element.des}</div>
            </div>
            })
           } 
            </div>
