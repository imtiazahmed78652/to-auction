...
function Hero() {
  ...
  return (
    <div className='h-[944px] bg-contained bg-no-repeat relative '  style= {{backgroundImage:'url(/hero-bg.png)',height:'944px'}}>
        <div className='w-[687px] flex flex-col absolute top-[252px] bottom-[267px] right-32 z-10 '>
            <h1 className={`font-normal text-[42px] text-black leading-[18px] ${monumentum.className}`}>Cartier Santos Medium</h1>
            ...
            <p className={`font-normal text-[36px] leading-[18px] mt-[24px] ${manrope.className}`}>Price:$200</p>
