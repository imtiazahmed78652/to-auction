  ...
  const faqs = [
    {
      ...
      answer:
        'To register, click the "Sign Up" button on the top-right corner of the homepage. Fill in the required information, including your name, email address, and a password. Once registered, you can start bidding on our luxury auctions.',
    },
    {
      ...
      <div className="mt-[32px] flex flex-col items-center justify-center  text-[#686868]">
        <div className="w-[1440px] px-[128px]">
          <div className="flex flex-row items-center gap-4">
            <p className="font-semibold text-xs text-[#BCBCBC] leading-[18px]">
              Home
            </p>
          ...
          <h1
            className={`font-normal text-[24px] leading-[25px] mt-16 text-black ${monumentum.className} `}
          >
            FAQs
          </h1>
              ...
              return (
                ...
                >
                  <div
                    className={`w-[1059px]  ${
                      idx === 3
                        ? "border-b-[2px] border-[#D4D2E3] mb-[93px]"
                        : ""
                    } cursor-pointer border-t-[1px] border-[#D4D2E3] py-[56px] flex flex-row items-center justify-between w-full`}
                    onClick={() => setState(idx)}
                  >
                    <div>
                      <h1 className="font-semobild text-[20px] leading-[27px] max-h-">
                        {element.question}
                      </h1>
                      {state === idx && (
                        <p className="w-[753px] mt-[16px]  ease-in-out">
                          {element.answer}
                        </p>
                      )}
                    </div>
