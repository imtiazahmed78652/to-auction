...
function Paginations() {
  ...
  let textClasses = "text-base text-black";
  let dotClasses = "";
  ...
  if (myHeadingText === "Enter Mobile Number") {
  ...
  } else if (myHeadingText === "Select Interest") {
    ...
    height = 23.5;
    firstLine = "bg-green";
  } else if (myHeadingText === "Choose Payment Method") {
    firstBorderClasses = "border-0 border-green";
    ...
    firstLine = "bg-green";
    secondLine = "bg-green";
  } else if (myHeadingText === "Enter Card Details") {
    firstBorderClasses = "border-0 border-green";
    secondBorderClasses = "border-0  border-green";
    thirdBorderClasses = "border-green";
    dotClasses = "bg-green w-full h-full";
  ...
  return (
    <div className="flex flex-col items-center justify-center ">
      <div className="flex flex-row items-center justify-between w-[441px]">
        <h1 className={`text-[12px] leading-[18px] text-green `}>
          Credentials
        </h1>
        <h1
          className={`text-[12px] leading-[18px] ${
            myHeadingText === "Select Interest" || "Choose Payment"
              ? "text-green"
              : "text-light-2"
          } `}
        >
      ...
      <div className="w-[441px] h-[71px] flex flex-row items-center justify-between">
        <div className="flex flex-col items-center">
          <div
            className={`w-[47px] h-[47px] flex flex-row rounded-full  items-center justify-center ${firstBorderClasses}`}
          >
            <div
              className={` ${dotClasses}  rounded-full flex flex-row items-center justify-center`}
            >
              <Image
                src="/check.png"
                width={width}
        ...
        <div className="flex flex-col items-center">
          <div
            className={`w-[47px] h-[47px] flex  flex-row  rounded-full items-center justify-center  ${secondBorderClasses}`}
          >
            <div
              className={`  rounded-full flex flex-row items-center  justify-center ${secondDotClasses}  `}
            >
              {
                <Image
                  src="/check.png"
        ...
        <div className="flex flex-col items-center">
          <div
            className={`w-[47px] h-[47px] flex flex-row border-[2.25px]   rounded-full items-center justify-center ${thirdBorderClasses} `}
          >
            <div
              className={`w-[11.75px] h-[11.75px]  rounded-full ${thirdDotClasses} `}
            ></div>
          </div>
        </div>
      </div>
