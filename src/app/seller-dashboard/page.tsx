...
import { data, earnings, activeItems } from "./data";
        ...
        <div className="max-w-[1440px] px-[128px]">
          ...
          <div className="flex flex-row  gap-6 mt-8">
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col px-8 border-[1px] border-[#E2E2E2] rounded-[4px] pt-[32px]">
                <div className="flex flex-row justify-between">
                  <h1 className="font-normal text-xl leading-[18px]">
                    Earnings
                  </h1>
                  <div className="flex flex-col items-end">
                    <h1 className="text-[#808080]">Available Funds</h1>
                    <p className="text-[#3AAE2A] font-bold text-lg leading-[18px] mt-[16px]">
                      $300
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col mt-[87px]">
                  <div className="w-full flex flex-row justify-between pb-[16px]">
                    <div className="text-[#828282] text-[14px] font-normal leading-[18px]">
                      Date
                    </div>
                    <div className="text-[#828282] text-[14px] font-normal leading-[18px]">
                      Activity
                  ...
                  <div className="flex flex-col">
                    {earnings.map((element, idx) => {
                      return (
                        <div
                          key={idx}
                          className="border-t-[1px] border-b-[1px] border-[#DDDDDDDD] py-[30px] flex flex-row items-center justify-between"
                        >
                          <div className="font-normal text-[12px] leading-[18px] text-black">
                            {element.date}
                          </div>
                          <div className="font-normal text-[12px] leading-[18px] text-black">
                            {element.activity}
            ...
            <div className="flex flex-col gap-8">
              <div className="h-[78px] flex flex-row items-center ">
                {data.map((element, idx) => {
                  return (
                    <div
                      key={idx}
                      className={`w-[195px]  h-full border-[1px] border-[#E2E2E2] flex flex-col items-center justify-center ${
                        idx === 0 ? "rounded-l-[4px]" : ""
                      } ${idx === 3 ? "rounded-r-[4px]" : ""}`}
                    >
                      <h1
                        className={`font-medium text-[14px] leading-[18px] text-[#A3A3A3]  `}
                      >
                        {element.name}
                      </h1>
              ...
              <div className="flex flex-row items-center gap-6">
                <div className="flex flex-col w-[378px] h-[241px] justify-between rounded-[4px] border-[1px] border-[#E2E2E2] px-[25px] py-[22px]">
                  <div className="flex flex-row items-center  justify-between w-full">
                    <div className="font-normal text-[18px] leading-[18px] flex flex-row items-center gap-[6px]">
                      {" "}
                      <span> Total Sales </span>{" "}
                      <div className="w-[90px] h-[32px] border-[1px] border-[#D9D9D9] rounded-[6px] text-[#D9D9D9] font-normal text-[12px] leading-[18px] flex flex-row items-center justify-between px-[8px]">
                        This Month{" "}
                        <Image
                          src="/dropdown.png"
                          alt=""
                    ...
                    <div className="flex flex-row items-center gap-[12px]">
                      ...
                      <p className="font-medium text-[14px] leading-[18px] text-blac  k">
                        $12,399
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex flex-row items-center justify-between">
                <h1 className="font-bold text-[20px] leading-[18px] text-black">
                  Active Items
                </h1>
                <button className="text-[#3AAE2A] font-bold text-[14px] leading-[18px] hover:underline hover:text-[#42723b]">
                  View All
                </button>
              </div>
              ...
              <div className="flex flex-col items-center gap-4">
                {activeItems.map((element, idx) => {
                  return (
                    <div
                      key={idx}
                      className="w-full  py-6 pr-8 pl-6 border-[1px] flex flex-row items-center justify-between border-[#E2E2E2] rounded-[4px]"
                    >
                      <div className="flex flex-col gap-4">
                        <p className="flex flex-row items-center gap-[8px] text-[#CCCCCC]">
                          Bid on:{" "}
                          <span className="text-[#6C6C6C] font-bold text-sm leading-[18.9px]">
                            {element.bidOn}
                          </span>
                        </p>
                        <div className="flex flex-row items-center gap-6 ">
                          <div className="flex flex-row items-center">
                            <span className="font-medium text-[12px] text-[#CCCCCC]">
                              {" "}
                              Date & Time:
                            </span>
                            <span className="text-[#6C6C6C] font-bold text-sm leading-[18.9px]">
                          ...
                          <div className="flex flex-row items-center gap-2 text-[#CCCCCC] font-medium text-xs leading-[18px]">
                            status{" "}
                            <span className={` ${element.status === 'Delivered' ? 'text-[#00BC13]' : 'text-[#CF2D2D]'} `}>{element.status}</span>
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-row items-center gap-6">
                        <div className={`text-[#CF2D2D] font-bold text-2xl leading-[34px]`}>
                          ${element.price}
                        </div>
                        <div className="font-medium text-[16px] leading-[34px] underline">
                          View Item
                        </div>
                      </div>
                    </div>
